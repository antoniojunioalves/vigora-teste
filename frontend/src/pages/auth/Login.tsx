  ...
  return (
    <div className="min-h-screen bg-background flex">
        ...
        <div className="relative z-10 max-w-lg mb-12">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              A plataforma de segurança operacional definitiva para advogados e escritórios de alta performance.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative">
        ...
        >
          <div className="lg:hidden flex items-center gap-3 text-primary font-display font-bold text-3xl mb-12 justify-center">
            <ShieldAlert className="w-8 h-8 text-primary" />
            VIGORA
          </div>
          ...
          <div className="glass-panel p-8 sm:p-10 rounded-3xl">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Link href="/recuperar-senha">
                    <span className="text-xs text-primary hover:underline cursor-pointer transition-all">Esqueceu a senha?</span>
                  </Link>
                </div>
                <input 
                  {...register("senha")}
              ...
              >
                {loginMutation.isPending ? (
                  ...
                  <><ShieldAlert className="w-5 h-5" /> Entrar com Segurança</>
                )}
              </button>
            </form>
            ...
            <div className="mt-8 text-center text-sm text-muted-foreground">
              Não tem uma conta?{' '}
              <Link href="/cadastro">
                <span className="text-primary hover:underline font-semibold cursor-pointer">Cadastre-se agora <ArrowRight className="inline w-3 h-3 ml-1" /></span>
              </Link>
            </div>
          </div>
        </motion.div>
